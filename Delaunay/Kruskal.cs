...
*/
	...
	public static List<LineSegment> kruskal(List<LineSegment> lineSegments)
    {
        return kruskal(lineSegments, "minimum");
    }
	public static List<LineSegment> kruskal(List<LineSegment> lineSegments, string type)
	{
		...
		switch (type)
		{
			...
			case "maximum":
				...
				break;
			default:
				lineSegments.SortFunc(LineSegment.compareLengths_MAX);
				break;
		}
